...
schools_cleaned %>%
  ...
  labs(title = "**_Reading and Math Test Scores across Races_**", y = "", x = "") +
...
schools_cleaned %>%
  ...
  general_plot_theme +
  without_xgrid_theme +
  ggtitle("**_Instruction Expenditures (in millions)<br>\tand Test Scores by Region Over Time_**") +
  xlab("Instruction Expenditures (in millions)") +
  ylab("Test Scores")
