...
```{r include=FALSE}
schools_cleaned <- read_csv(here::here("us_schools_cleaned.csv"),
                            col_types = cols(
                              TOTAL_EXPENDITURE = col_double(),
                              INSTRUCTION_EXPENDITURE = col_double(),
                              SUPPORT_SERVICES_EXPENDITURE = col_double(),
                              OTHER_EXPENDITURE = col_double(),
                              CAPITAL_OUTLAY_EXPENDITURE = col_double(),
                              Year = col_double(),
                              State = col_factor(NULL),
                              Decade = col_double(),
                              Grade = col_factor(NULL),
                              Race = col_factor(NULL),
                              Sex = col_factor(NULL),
                              Test = col_factor(NULL),
                              `Test Score` = col_double(),
                              `State Code` = col_factor(NULL),
                              Region = col_character(),
                              Division = col_factor(NULL)
                            ))
```
