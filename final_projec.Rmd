...
```{r include=FALSE}
schools <- read_xlsx(here::here("FinalProject-STAT331", "US_schools_data.xlsx"))
regionizer <- read_csv(here::here("FinalProject-STAT331", "us census bureau regions and divisions.csv"))
```
